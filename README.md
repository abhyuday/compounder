...
| **Family and Circle** | **Both** required: **Presence** (one undistracted block with one specific person, phone in another room) **and** **Love** (showed love out loud — a word, gesture, or act of care that someone actually felt). |
